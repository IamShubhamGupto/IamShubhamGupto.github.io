...
<div style="text-align: justify">
  <p>
    Hey there!  I am a software developer passionate about solving problems related environment perception and interactions. I have made some cool solutions with the help of cameras, sensors and Claude in my most recent endeavours in the AR/VR space. I am currently exploring on-device inference and ways to bridge wearable tech with the five human senses.
  </p>

  <p>
    I completed my Masters in Computer Engineering from New York University in May 2024. I worked actively with <a href='https://engineering.nyu.edu/faculty/chen-feng'>Dr. Chen Feng</a> at <a href='https://ai4ce.github.io'>AI4CE lab</a> on Active Learning for Neural Radiance Fields and optimizing inference for visual place recognition for my Masters project. Addtionally, I worked as a Climate Modeling Research Assistant at <a href= 'https://m2lines.github.io'>M<sup>2</sup>LInES</a> advised by <a href='https://zanna-researchteam.github.io'>Dr. Laure Zanna</a>. My responsibilities include optimizing resources utilization in HPC clusters and maintaining websites. Extracurricularly, I led the Computer Vision subteam at NYU ARC Robotics, where I managed and worked with an interdisciplinary team of fifteen to train, optimize, and deliver a detection, forecasting and localization solution for the ARC 23', 24' (previously RMNA).
  </p>
